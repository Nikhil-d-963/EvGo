...
public class feedBack extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        documentReference.addSnapshotListener(feedBack.this, new EventListener<DocumentSnapshot>() {
            @Override
        ...
        issueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DocumentReference documentReference = firebaseFirestore.collection("EvGo-User-feedBack-"+userId).document(uuid);
                ...
                user.put("feedBack",issueText);
                user.put("date_of_feedBack",dateOfIssue);
